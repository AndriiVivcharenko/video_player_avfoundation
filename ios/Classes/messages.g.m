...
+ (FLTMixWithOthersMessage *)fromMap:(NSDictionary *)dict {
  ...
  pigeonResult.controlAVAudioSesson = GetNullableObject(dict, @"controlAVAudioSesson");
  NSAssert(pigeonResult.controlAVAudioSesson != nil, @"");
  return pigeonResult;
}
- (NSDictionary *)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.mixWithOthers ? self.mixWithOthers : [NSNull null]), @"mixWithOthers", (self.controlAVAudioSesson ? self.controlAVAudioSesson : [NSNull null]), @"controlAVAudioSesson", nil];
}
@end

@implementation FLTInitializeMessage
+ (instancetype)makeWithControlAVAudioSesson:(NSNumber *)controlAVAudioSesson {
...
- (NSDictionary *)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.controlAVAudioSesson ? self.controlAVAudioSesson : [NSNull null]), @"controlAVAudioSesson", nil];
}
@end
